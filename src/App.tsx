...
function App() {
  ...
  const [items,setItems] = useState<IState["items"]>([
    ...
    },  
    {
      ...
      price: 150,
      description: "AR4071 Clean Force Red Cyclone Filter Vacuum Cleaner, HIGH PERFORMANCE"
    },  
    {
      name: "Arva - Axe V3 Shovel",
      url: "https://www.bfgcdn.com/600_600_90/407-0009-0111/arva-axe-v3-shovel-avalanche-shovel.jpg",
      price: 75,
      description: "The Axe V3 shovel from Arva is a very strong avalanche shovel. It is especially well suited for people looking for a compact and versatile option"
    },  
